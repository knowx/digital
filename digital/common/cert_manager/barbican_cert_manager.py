...
from digital.common import exception as digital_exc
...
class CertManager(cert_manager.CertManager):
    ...
    def store_cert(certificate, private_key, intermediates=None,
        ...
        except digital_exc.CertificateStorageException:
    ...
    @staticmethod
    def get_cert(cert_ref, service_name='Digital', resource_ref=None,
        ...
        :return: Digital.certificates.common.Cert representation of the
                 certificate data
    ...
    @staticmethod
    def delete_cert(cert_ref, service_name='Digital', resource_ref=None,
                    **kwargs):
